...
namespace RESTClient
{
    ...
    class Program
    {
        ...
        {
            //es un do-while dentro de main
            do
            {
                //try catch para manejo de expeciones
                try
                {   
                    //ingresae el metodo
                    string content;
                    Console.WriteLine("Enter Method:"); // get post put o delete
                    string Method = Console.ReadLine();

                    Console.WriteLine("Enter URI:"); //http:://localhost:xxxxx/restservice
